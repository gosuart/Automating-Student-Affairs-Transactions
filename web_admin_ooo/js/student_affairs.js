...
async function loadRequests() {
    ...
    try {
        const response = await fetch('../backend/api/student_affairs/requests.php?action=get_cards_data');
...
async function confirmApproveRequest() {
    ...
    try {
        const response = await fetch('../backend/api/student_affairs/requests.php', {
            method: 'POST',
            headers: {
